							...
							<div class="profile-detail">
								<div class="profile-info">
									...
									<ul class="list-unstyled list-justify">
										<li>Registration Date <span><fmt:formatDate
													value="${authInfo.memberRegisterDate}" pattern="yyyy-MM-dd" /></span></li>
										<li>Mobile <span>${authInfo.memberPhoneNumber }</span></li>
										<li>Email <span>${authInfo.memberId }</span></li>
										<li>Website <span><a
												href="https://blog.naver.com/payo03">https://blog.naver.com/payo03</a></span></li>
									</ul>
								</div>
								<div class="profile-info">
									...
									<ul class="list-inline social-icons">
										...
										<li><a href="https://github.com/payo03" class="github-bg"><i
								...
								<div class="text-center">
									<a href="${pageContext.request.contextPath}/edit"
										class="btn btn-primary"><spring:message code="member.edit" /></a>
								</div>
							</div>
							<!-- END PROFILE DETAIL -->
						</div>
